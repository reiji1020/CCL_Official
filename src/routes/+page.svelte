...
<main>
    ...
    <div class="activity-card-wrapper">
        ...
        <div class="card-padding">
            <Card borderColor="--strawberry-pink" bgColor="--peach-pink" src="./20221021.jpg"
                  altText="実践入門ビジュアルプログラミング言語" title="vvvv&vvvv gamma本発売中！"
                  cardText="各ネット書店でビジュアルプログラミング言語vvvvとvvvv gammaの本を発売中です。"/>
        </div>
    </div>
    <ActivityLog/>
    <div style="display: flex; justify-content: center; align-items: center">Comming Soon...</div>
    <!--    Member-->
    <Member/>
    <Members/>
</main>
